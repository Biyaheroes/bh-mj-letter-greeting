...
module.exports = function build( parameter ){
	...
	return {
		"entry": parameter.test? "./test.js" : "./letter-greeting.support.js",
		...
		"output": {
			"library": parameter.test? "test" : "letter-greeting",
			"libraryTarget": "umd",
			"filename": parameter.test? "test.deploy.js" : "letter-greeting.deploy.js"
		},
